import client1 from "/public/Images/StartUp/Client1.jpg";
import client2 from "/public/Images/StartUp/Client2.jpg";
import client3 from "/public/Images/StartUp/Client3.jpg";
import client4 from "/public/Images/StartUp/Client4.jpg";
        ...
        <div className="flex flex-wrap justify-center -mx-4">
            ...
            <div className="shadow-testimonial-6 dark:shadow-none relative mb-10 overflow-hidden rounded-[10px] bg-white border-2 border-gray-100 dark:border-none dark:bg-[#1F2A37] dark:bg-dark-2 p-8 sm:p-10 md:py-10 md:px-6 lg:p-10">
              <div className="flex items-center mb-10">
                <div className="mr-5 h-20 w-full max-w-[80px] overflow-hidden rounded md:h-[60px] md:max-w-[60px] lg:h-20 lg:max-w-[80px]">
                  <img src={client1} alt="image" className="w-full" />
                </div>
          ...
          <div className="w-full px-4 md:w-1/2">
            <div className="shadow-testimonial-6 dark:shadow-none relative mb-10 overflow-hidden rounded-[10px] bg-white border-2 border-gray-100 dark:border-none dark:bg-[#1F2A37] dark:bg-dark-2 p-8 sm:p-10 md:py-10 md:px-6 lg:p-10">
              <div className="flex items-center mb-10">
                <div className="mr-5 h-20 w-full max-w-[80px] overflow-hidden rounded md:h-[60px] md:max-w-[60px] lg:h-20 lg:max-w-[80px]">
                  <img src={client2} alt="image" className="w-full" />
                </div>
                <div className="w-full">
                  <h5 className="mb-1 text-lg font-semibold text-dark dark:text-white">
                    Anee Doe
          ...
          <div className="w-full px-4 md:w-1/2">
            <div className="shadow-testimonial-6 dark:shadow-none relative mb-10 overflow-hidden rounded-[10px] bg-white border-2 border-gray-100 dark:border-none dark:bg-[#1F2A37] dark:bg-dark-2 p-8 sm:p-10 md:py-10 md:px-6 lg:p-10">
              <div className="flex items-center mb-10">
                <div className="mr-5 h-20 w-full max-w-[80px] overflow-hidden rounded md:h-[60px] md:max-w-[60px] lg:h-20 lg:max-w-[80px]">
                  <img src={client3} alt="image" className="w-full" />
                </div>
                <div className="w-full">
                  <h5 className="mb-1 text-lg font-semibold text-dark dark:text-white">
                    Dipali Dow
          ...
          <div className="w-full px-4 md:w-1/2">
            <div className="shadow-testimonial-6 dark:shadow-none relative mb-10 overflow-hidden rounded-[10px] bg-white border-2 border-gray-100 dark:border-none dark:bg-[#1F2A37] dark:bg-dark-2 p-8 sm:p-10 md:py-10 md:px-6 lg:p-10">
              <div className="flex items-center mb-10">
                <div className="mr-5 h-20 w-full max-w-[80px] overflow-hidden rounded md:h-[60px] md:max-w-[60px] lg:h-20 lg:max-w-[80px]">
                  <img src={client4} alt="image" className="w-full" />
                </div>
                <div className="w-full">
                  <h5 className="mb-1 text-lg font-semibold text-dark dark:text-white">
                    John Doe

...
const Dealing = () => {
  return (
    <>
    <section className="pt-20 lg:pt-[120px] dark:bg-dark bg-white dark:bg-[#111928]">
      <div className="container mx-auto">
        <div className="relative z-10 overflow-hidden rounded bg-blue-600 py-12 px-8 md:p-[70px]">
          <div className="flex flex-wrap items-center -mx-4">
            <div className="w-full px-4 lg:w-1/2">
              ...
              <h2 className="mb-6 text-3xl font-bold leading-tight text-white sm:mb-8 sm:text-[40px]/[48px] lg:mb-0">
                <span className="xs:block"> Get started with<br /> </span>
            ...
            <div className="w-full px-4 lg:w-1/2">
              <div className="flex flex-wrap lg:justify-end">
                ...
                <a href="javascript:void(0)" className="inline-flex py-3 my-1 text-base font-medium text-white transition rounded-md bg-green-400 px-7 hover:bg-opacity-90">
                  Start Free Trial
                </a>
              </div>
            </div>
